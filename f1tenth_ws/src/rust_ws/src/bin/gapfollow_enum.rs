...
impl SteeringCategory {
    ...
    fn speed_for_mode(&self, mode: DrivingMode) -> f32 {
        match (self, mode) {
            ...
            (SteeringCategory::Straight, DrivingMode::Test) => 2.5,
            (SteeringCategory::SlightCurve, DrivingMode::Test) => 2.3,
            (SteeringCategory::GentleCurve, DrivingMode::Test) => 1.5,
            (SteeringCategory::MediumCurve, DrivingMode::Test) => 1.0,
